    ...
    <div className="Referrel position-relative">
      <Container>
        ...
        <div className="scroll-wrapper1 position-relative overflow-hidden">
          <div className="scroll-card1 d-flex" ref={scrollRef}>

            {/* CARD 1 */}
            <div className="offer-card">
              <img src={Offercard1} className="offer-full-img" />
              <div className="offer-overlay">
                <h5 className="fw-bold">Refer a friend, and you both get £50</h5>
                <p>Turn connections into rewards.<br/>Get credited after successful booking.</p>
                <button className="offer-btn">Refer Now</button>
              </div>
            </div>
            ...
            <div className="offer-card">
              ...
              <div className="offer-overlay">
                <h5 className="fw-bold">Amberscholar 2025 Edition is Here!</h5>
                <p>Win upto $12,000 & study in the UK,<br/>USA, Canada, or Ireland.</p>
            ...
            <div className="offer-card">
              ...
              <div className="offer-overlay">
                <h5 className="fw-bold">Save up to £300 with amber+</h5>
                <p>Get exclusive discounts from 150+ trusted 
<br/>partners at this one-stop student platform</p>
            ...
            <div className="offer-card">
              ...
              <div className="offer-overlay">
                <h5 className="fw-bold">Get additional £20 cashback on your
 booking!</h5>
                <p>Book your student accommodation via the amber 
