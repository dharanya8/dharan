...
import amber from '../../assets/bg1/amber-logo-dark.svg';
import { Container } from "react-bootstrap";
import LoginModal from "../LoginModal";
import Search from "../Search";
// import { useState } from "react";
import { useNavigate } from "react-router-dom";
import { endSession, isLoggedIn as hasValidSession } from "../utils/auth";
import { readList, removeItem } from "../utils/storage";
          ...
          <Nav className="ms-auto navbar-nav">
            ...
            <Dropdown className="mb-5 mb-lg-0 mx-lg-2  contact-btn">
              <Dropdown.Toggle
                id="contact-dropdown"
                variant="none"
                className="text-dark fw-bold  toggle"
                style={{
                  fontFamily: "'Nunito', sans-serif",
                  fontSize: "16px",
                  height: "40px",
